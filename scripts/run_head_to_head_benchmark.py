...
BENCHMARK_QUERIES = [
    ...
    ("Jaki jest status Cognitive Pipeline?", "Entity", True),
    ...
    ("Jaki model jest używany dla roli Bota?", "Entity", True),
    ("Co to jest circuit breaker w Cognitive Pipeline?", "Entity", True),
    ...
    ("Jakie są role w triadzie Cognitive Pipeline?", "Entity", True),
    ...
    ("Co wdrożono w fazie V23 Cognitive Pipeline?", "Architecture", True),
    ...
    ("Jakie mutacje testowe wstrzykiwał Auditor w V12?", "Architecture", True),
    ...
    ("Kiedy Gemini 3.7 Flash High został zatwierdzony dla roli Bota?", "Temporal", True),
    ...
    ("Kiedy dodano testy mutacyjne dla audytorów Auditor?", "Temporal", True),
