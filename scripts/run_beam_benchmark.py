...
3. Queries Answer LLM (omniroute/default-model via OmniRoute).
4. Evaluates response via Judge LLM (omniroute/default-model) using 0/1 rubric.
...
DEFAULT_MODEL = os.environ.get("ATLAS_MODEL", "omniroute/default-model")
