...
def test_no_hardcoded_user_home():
    """Assert 2: Plik NIE zawiera twardo zakodowanej ścieżki /home/<user> (H1)."""
    content = INSTALL_SCRIPT.read_text(encoding="utf-8")
    assert not re.search(r"/home/[a-zA-Z0-9_.-]+", content), "Hardcoded user home path znaleziony w skrypcie instalacyjnym (H1)"
